...
function isAdminTab(value: string | undefined): value is Tab {
...
export function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<Tab>(page.name === "admin" && isAdminTab(page.tab) ? page.tab : "overview");
  ...
  useEffect(() => {
    if (page.name === "admin" && isAdminTab(page.tab)) {
            ...
            <div className="grid lg:grid-cols-3 gap-5 min-w-0">
              ...
              <div className="lg:col-span-2 min-w-0 bg-white rounded-[1.25rem] border border-[rgba(12,13,26,0.07)] shadow-[0_1px_3px_rgba(12,13,26,0.05)] p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={() => selectTab("documents")} className="text-xs font-semibold text-indigo-600 hover:text-indigo-700 flex items-center gap-1">
            ...
            {(adminDashboard.data?.failed_documents.length ?? 0) > 0 && (
              <div className="bg-red-50 border border-red-100 rounded-[1.125rem] p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={() => selectTab("indexing")} className="text-xs font-semibold text-red-600 hover:text-red-700 flex items-center gap-1">
